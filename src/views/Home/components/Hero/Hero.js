...
const images = [
  {
    group: [
      {
        cover:
          'public/images/iconic_image.png',
        coverDark:
          'public/images/iconic_image.png',
      },
    ],
          ...
          <Container>
            <Box maxWidth={{ xs: 1, sm: '50%' }}>
              ...
              <Typography
                ...
                sx={{ fontWeight: 400 }}
              >
                {/* We Develop modern user friendly products with the latest technologies,
                Dev Smart Solutions, */}
                We Develop Smart Solutions with the latest technologies for modern user friendly
                products & services tailored to your needs
                {/* Dev Smart Solutions will make your product look modern and professional
